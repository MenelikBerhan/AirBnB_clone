#!/usr/bin/python3
"""
`TestState` test case to test the `State` class
"""
...
class TestState(unittest.TestCase):
    """Tests for 'State' class attributes and methods"""

    def setUp(self):
        """Create instances of State class for testcases"""
        self.a = State()
        self.b = State()
        self.c = State()
    ...
    def test_init_method(self):
        ...
        a_1 = State(**self.a.to_dict())
        a_2 = State('1', '2', '3', **self.a.to_dict())
    ...
    def test_methods(self):
        ...
        self.assertTrue(hasattr(State, method) for method in methods)
