#!/usr/bin/python3
"""
`TestAmenity` test case to test the `Amenity` class
"""
...
class TestAmenity(unittest.TestCase):
    """Tests for 'Amenity' class attributes and methods"""

    def setUp(self):
        """Create instances of Amenity class for testcases"""
        self.a = Amenity()
        self.b = Amenity()
        self.c = Amenity()
    ...
    def test_class_init(self):
        ...
        self.assertTrue(all(type(obj) == Amenity for obj in self.objects))
        self.assertTrue(all(isinstance(obj, (Amenity, BaseModel))
                            for obj in self.objects))

    def test_init_method(self):
        """Tests __init__method"""
        a_1 = Amenity(**self.a.to_dict())
        a_2 = Amenity('1', '2', '3', **self.a.to_dict())
    ...
    def test_methods(self):
        ...
        self.assertTrue(hasattr(Amenity, method) for method in methods)
    ...
    def test_str(self):
        ...
        self.assertTrue(str(obj) == "[Amenity] ({obj.id}) {obj.__dict__}"
                        for obj in self.objects)
