#!/usr/bin/python3
"""
`TestReview` test case to test the `Review` class
"""
...
class TestReview(unittest.TestCase):
    """Tests for 'Review' class attributes and methods"""

    def setUp(self):
        """Create instances of Review class for testcases"""
        self.a = Review()
        self.b = Review()
        self.c = Review()
    ...
    def test_init_method(self):
        ...
        a_1 = Review(**self.a.to_dict())
        a_2 = Review('1', '2', '3', **self.a.to_dict())
    ...
    def test_class_attributes(self):
        ...
        self.assertTrue(hasattr(Review, attr) for attr in attributes)
    ...
    def test_methods(self):
        ...
        self.assertTrue(hasattr(Review, method) for method in methods)
    ...
    def test_str(self):
        ...
        self.assertTrue(str(obj) == "[Review] ({obj.id}) {obj.__dict__}"
                        for obj in self.objects)
