#!/usr/bin/python3
"""
`TestCity` test case to test the `City` class
"""
...
class TestCity(unittest.TestCase):
    """Tests for 'City' class attributes and methods"""

    def setUp(self):
        """Create instances of City class for testcases"""
        self.a = City()
        self.b = City()
        self.c = City()
    ...
    def test_class_init(self):
        ...
        self.assertTrue(all(type(obj) == City for obj in self.objects))
        self.assertTrue(all(isinstance(obj, (City, BaseModel))
                            for obj in self.objects))

    def test_init_method(self):
        """Tests __init__method"""
        a_1 = City(**self.a.to_dict())
        a_2 = City('1', '2', '3', **self.a.to_dict())
    ...
    def test_class_attributes(self):
        ...
        self.assertTrue(hasattr(City, attr) for attr in attributes)
    ...
    def test_methods(self):
        ...
        self.assertTrue(hasattr(City, method) for method in methods)
    ...
    def test_str(self):
        ...
        self.assertTrue(str(obj) == "[City] ({obj.id}) {obj.__dict__}"
                        for obj in self.objects)
